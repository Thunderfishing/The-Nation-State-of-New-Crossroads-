...
| Arbitration | Ad-hoc tribunals (§6.6) | Deadlock resolution only | Each side picks one; the two pick a chair; dissolves after |
...
**6. The oversight committees depend on session discipline.** The quarterly sessional model concentrates committee work into four windows. The mitigations: the mandatory review calendar (§6.2) and the citizen-initiative threshold drop when chambers miss their cycle.
