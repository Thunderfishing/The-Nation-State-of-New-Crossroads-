...
1. [Overview](#overview)
2. [Section 1: Monetary System](#section-1-monetary-system)
   - [1.1 Dual Currency System](#11-dual-currency-system--two-layer-velocity-architecture)
   - [Physical Cash — Layer 1](#physical-cash--layer-1)
   - [Bulwark Coin (BWC) — Layer 2](#bulwark-coin-bwc--layer-2)
   - [1.2 Co-op Credit Union Network](#12-co-op-credit-union-network)
   - [1.3 Transaction Fees & Liquidity Pool](#13-transaction-fees--liquidity-pool)
   - [1.4 Daily Living Basket (DLB)](#14-daily-living-basket-dlb)
   - [1.5 Base Money Issuance & the BWC Anchor](#15-base-money-issuance--the-bwc-anchor)
   - [1.6 Citizen Wallet Structure](#16-citizen-wallet-structure)
   - [1.7 Personal Market Index (PMI) — Economic Health Dashboard](#17-personal-market-index-pmi--economic-health-dashboard)
3. [Section 1A: Informal Economy Guarantee](#section-1a-informal-economy-guarantee)
4. [Section 2: Sovereign Wealth Fund (SWF)](#section-2-sovereign-wealth-fund-swf)
5. [Section 3: Co-op Ecosystem Integration](#section-3-co-op-ecosystem-integration)
6. [Section 4: Tax and Economic Reforms](#section-4-tax-and-economic-reforms)
   - [4.1 Corporate Governance Requirements](#41-corporate-governance-requirements)
7. [Section 5: Governance, Data & Oversight (PPK/CED)](#section-5-governance-data--oversight-ppkced)
8. [Section 6: Foreign Investment — CGCI](#section-6-foreign-investment--crossroads-global-co-op-index-cgci)
9. [Key Stats (2025–2075)](#key-stats-20252075)
10. [Design Philosophy](#design-philosophy-informative)
...
- **A self-limiting Sovereign Wealth Fund** — ~$550B scaling to ~$2.0T, capped at 12% of GDP, with automatic citizen dividends and contribution cuts above the cap.
- **The PPK/CED architecture** — identity, credentials, and voting in the citizen-held Professional Passport Key; pseudonymized economic data in the Centralized Economic Database; the two never joined except through a warranted Judicial Link Box.
...
- **Layer 2 — BWC (Store-of-Value / Formal Layer):** digital BWC. Transparent (pseudonymously) above $10,000, stable by design. Handles savings, large purchases, institutional transactions, and international trade.
...
- **Purpose of the metal flecks — two functions, neither of them currency backing:**
  1. **Security / anti-counterfeiting** — real precious metal, polymer substrate, and holographic optics together place counterfeiting beyond non-state actors.
  2. **Catastrophe floor** — in the event of a currency collapse, the standardized metal content lets cash continue to circulate as commodity money, re-priced to its metal value. The informal economy keeps a functioning medium of exchange even if digital BWC fails — buying the state time to restructure. Melt value sits far below face at any plausible metal price, so parity holds in normal times and notes are never melted absent a true collapse.
...
- **Confidence backing (not redemption backing):** the collective mutual capital of 5,000 credit unions, the Deposit Insurance Pool, and the SWF guarantee. This is an honest acknowledgment that all money rests on trust; Crossroads puts that trust in plain sight rather than behind a redemption promise it could not universally honor.
- **How BWC is created — two taps, and only two:**
  1. **Treasury base issuance** — Treasury prints cash (= base BWC), governed by the anchor in Section 1.5.
  2. **Credit-union lending** — credit unions create broad digital BWC by lending (loans create deposits), capped by the 10% reserve requirement (Section 1.2). Broad money ≈ base × ~10.
  No other channel creates BWC.
- **Transaction Fees:** 0% under $100; 1% for $100–$10,000; 1.5% for $10,001–$100,000; 2% above $100,000.
- **Transparency Threshold:** digital BWC transactions above $10,000 are recorded **pseudonymously** in the CED (Section 5) and auditable via warrant. Transactions below $10,000 are private. Cash is never recorded.
...
Credit unions operate under the **Credit Union Act of 2025**, which establishes Regional Liquidity Pools (RLPs), the Deposit Insurance Pool (DIP), and voting-linked deposit insurance. These are referenced here; full detail is in that act.
...
- **Structure:** 5,000 credit unions (250 per region).
...
- $500,001–$1M: standard review, Regional Board notification.
...
- **Banking Suite:** checking, savings (~5–6%), mutual funds, GICs, bonds, savings bonds, retirement (~6–8%), reachable through the wallet (Section 1.6).
- **Shares:** base shares (up to 1,000 per citizen, ~4–8% dividends); special shares (member capital — see Credit Union Act).
- **Crossroads Loan Service (CLS):** ~60,000 officers (3,000/region) administer loans, student ventures, bankruptcy recovery, and informal-sector engagement, with discretion tiered by loan size.
...
- **Wartime Fee:** 10% on BWC transactions above $10,000 (5-year cap, 7/11 renewal); cash and cash-to-BWC swaps exempt entirely.
...
2. **Citizens' Metals ETF position** — an optional investment in the national gold/silver fund. Earns returns for the holder; grows the metals reserve as a byproduct. This is savings, **not currency** — the metal backs ETF shareholders, not BWC.
3. **Credit-union shares** — membership/ownership stake and dividends.
4. **Banking gateway** — access to savings, GICs, retirement, loans, and micro-loans.
...
- **Initial:** ~$550B (2025). **Target (2075):** ~$1.5–2.0T (capped at 12% of GDP).
- **Contributions are carved out of general revenue** (not additional), to avoid double-counting:
  - Financial transactions tax (0.3% on BWC >$10,000): ~$150B/year
  - Corporate SWF contribution (5% of profit over $10M): ~$60B/year
  - Resource surcharge (3% on minerals/energy): ~$50B/year
  - Other dedicated fees/tariffs: ~$103B/year
  - **Total contributions: ~$363B/year**, supplemented by SWF investment returns (~$27B in 2025, growing) and the general budget surplus.
...
**SWF as ultimate backstop:** the SWF reinsures Regional DIPs and acts as lender of last resort to exhausted RLPs only after 5 Regional Boards jointly certify an emergency (5/20) — preserving the anti-bailout ethos with systemic resilience.
...
- **The 25-year cycle:** every 25 years, **up to 50% of qualifying co-op debt** may be forgiven. This is **not** a blanket cancellation — it is **surgical** (see CLS below). Forgiveness is granted case by case, to co-ops whose distress arose from circumstances beyond their control.
...
- **Profit-sharing waterfall (progressive).** After expenses, the 5% profit tax, patronage, capital investment, and CCIF, the **commons share of remaining profit scales by co-op size**, bound by the Co-op Advantage Principle:
  ...
  The commons share splits Healthcare : Education : Charity in a 2:1:2 ratio. **Total commons funding ≈ $125B/year** (~$50B healthcare, ~$25B education, ~$50B charity), concentrated in large co-ops while protecting small ones.
...
- **Asymmetric Scrutiny:** simplified reporting for small FCLs; full CED disclosure above $1M revenue; quarterly audits and public hearings above $100M.
...
2. **Quarterly Guidance Ban:** annual guidance only. Violations: $1M, then $10M, then trading suspension.
...
- **Professional Passport Key (PPK):** a citizen-held, air-gapped hardware key holding identity, credentials, professional licensing, voting eligibility, and education — **and no economic data.** Verification is by zero-knowledge proof (prove eligibility without revealing identity).
...
| Elite (above $100k or $1M assets) | Full pseudonymized detail; quarterly audits; holdings above $10M publicly disclosed. |
...
- **Treasury:** administers BWC issuance under the Section 1.5 anchor, the SWF, and the Citizens' Metals ETF. Publishes the annual DLB, cash-adequacy figures, and base-issuance reports. **Treasury does not publish a backing ratio** — BWC is fiat; there is no per-coin metal backing.
- **Data cost:** CED (~$200M/year) + PPK mesh (~$250M/year) ≈ $450M/year, a net saving versus prior centralized data systems.
...
| Defense Fund (separate endowment) | ~$0 | ~$920B (bequests + returns) |
| Citizens' Metals ETF (investment, not backing) | $125–175B | $407–504B |
| Loans | ~$452B | ~$1.21T |
| Credit Unions | 5,000 | — |
