...
description: "Companion legislation to the Monetary Act 9.7, Credit Union Act 5.7, the Sovereign Functions Act, the Chamber Act, the FCL Structure Act 3.2, and the Industry Act 4.2. Establishes the Crossroads Exchange in two firewalled segments: a Domestic Core (trading venues for the Co-op Capital Index, credit-union special shares, domestic corporate equity, and the Citizens' Metals ETF) under one anti-speculation rulebook, and a Global Sound-Capital Segment through which foreign cooperatives, mutuals, and disciplined corporations may list by restructuring to the Crossroads rulebook and submitting to independent audit-to-standard. Governance: the domestic Exchange is a thin non-profit utility under Territorial Chamber oversight; indexes are managed by their own governing bodies; the global segment's statecraft powers sit with the Sovereign Council (Sovereign Functions Act §2.4)."
---

# Crossroads Exchange Act of 2025: Draft 1.5
...
Companion to the **Monetary Act 9.7** (the issuance anchor §1.5, the Reference Rate Anchor §1.5A, the Crisis-Management section §1.8, the CGCI §6, the corporate-governance requirements §4.1, the PPK/CED §5, the Citizens' Metals ETF §1.6), the **Credit Union Act 5.7** (special shares §3.2, the CUSM §3.3, tier caps §2.2), the **Sovereign Functions Act** (the global-segment statecraft powers §2.4, the Special Auditors §3, the judiciary §4, the SWF §5, the Sovereign Council §6, the four Bureaus §6A), the **Chamber Act** (the Territorial Chamber §3, the Co-op Chamber §4.1, the Corporate Chamber §4.2, the entrenched floors §11, the protected guarantees §12 including the corporate-governance requirements as §12.3), the **FCL Act 3.2**, and the **Industry Act 4.2**.
...
- **The Co-op Capital Index** is the pool of non-voting FCL investor shares, managed by the **CCIF Alliance Network** under Co-op Chamber and Sovereign Council oversight.
...
- **Debt:** there is no debt board. Crossroads issues no sovereign bonds and runs no repo (Monetary §1.5A); the tradable universe is ownership and (now on-exchange) the metals ETF — never debt or rates.
...
- **Index/Pool stewards:** the **CCIF Alliance Network** manages the Co-op Capital Index under Co-op Chamber and Sovereign Council oversight; **Treasury** manages the Citizens' Metals ETF and provides NAV calculations; **individual credit unions** manage their own special shares; **individual corporations** manage their own equity.
...
- **Listing approval chain (domestic):** Regional Board (6/11) → relevant Productive Chamber → Territorial Chamber (simple majority). The capital-intensive corporate exception (3.3) requires Sovereign Council approval (5/7) plus the Community Benefit and Labor Peace Agreements. The Metals ETF Board is listed by Treasury in consultation with the Exchange Authority; no discretionary approval is required beyond ensuring compliance with the rulebook.
- **Global-segment governance:** the Sovereign Council holds the statecraft powers (Sovereign Functions Act §2.4) — accrediting auditors, approving/suspending foreign listings on foreign-policy or national-security grounds, and the phase-two activation determination — with citizen oversight via the 1% petition mechanism (Sovereign Functions Act §2.4).
...
- **Enforcement:** violations of the Section 2.5 prohibitions (attempting to tranche, create derivatives, short, or leverage listed instruments) are void as transactions and carry fines via the relevant Department and the Corporate Chamber (for §4.1 violations), with appeal to ad-hoc arbitration (Chamber Act §6.6) and, on procedural grounds, the Supreme Court (Sovereign Functions Act §4).
...
| Firewall | Separate clearing; no cross-collateralization; no co-mingled funds; no domestic backstop for global; global excluded from §1.8 crisis signal |
| Off the exchange | Sovereign metals reserve (never listed); no debt board |
...
| Corporate exception | Sovereign Council 5/7 + CBA + Labor Peace; hard 33% insider floor |
...
- **It is a market for ownership and real assets, never debt.** There are no bonds to trade, no repo, no rates. The entire tradable universe is a slice of someone's productive enterprise or a claim on a permanent metal reserve. A trader here can never speculate on sovereign debt or interest rates, because those instruments do not exist.
