...
### 3.1 Curriculum & the School→Apprenticeship Flip
...
- **Ages 17–18 (Secondary — Credentialing):** committed to the chosen path. School-primary curriculum with **3 weeks/year apprenticeship**. Career-path specialization:
...
**The training timeline this produces (example — a doctor):** part of age 16 (exploration into medicine) + ages 17, 18 (school-primary credentialing) + ages 19, 20 (full-time clinical apprenticeship) ≈ **4+ solid years of training by age 20.** A journeyman doctor arriving at a hospital at 20 therefore needs only **~2 more years under master/grandmaster supervision** to reach full credential — front-loaded training means short on-the-job supervision. The same front-loading applies across all trades.
...
- Student ventures (ages 12–15) supported with small **CLS-issued venture loans** ($500, reference + 1.5%, lenient criteria), loan advice, and operational mentorship from masters or FCL board members. Supplemental and scale-up loans for exceptional ventures.
- **CLS Student-Venture Liaison (Credit Union Act §5.3).** Each Local School Board (§3.2) designates a CLS field agent from the nearest credit union as the school's **venture liaison**. The liaison visits regularly during the school year, reviews applications, provides mentorship, and connects students to masters in their trade. The agent who lends to hempcrete co-ops mentors the student's hempcrete venture — trade knowledge and credit judgment in one person. ~400,000 ventures/year estimated at ~10% participation; absorbed within the existing CLS corps as transaction-count work. No new funding required — the loans come from the loan book, the mentorship comes from agent time already budgeted.
...
- Policing is a standard blue-collar vocational trade on the journeyman–master–grandmaster ladder, identical to all skilled trades. **No college degree or external certification** may be required or weighted in hiring, promotion, or credentialing.
...
- **Progression:** identical merit-based journeyman → master → grandmaster ladder, metrics tracked via PPK/CED.
...
| :--- | :--- | :--- | :--- |
| Journeyman Teacher (yrs 1–3) | Licensed, credential, 80% student proficiency | ~$60,000 | None |
| Master Teacher | 5+ years, 5+ apprentice teachers mentored, 80% proficiency | ~$80,000–100,000 | per-share bonus |
| Grandmaster Teacher | 10+ apprentices mentored, 80% mentee retention, major instructional impact | ~$120,000–150,000 | larger per-share bonus |

- Master/Grandmaster privileges: mentor journeyman and apprentice teachers (including 19–20 service apprentices), Teacher Council leadership, priority professional-development funding; Grandmasters eligible for NLC technical-expert positions.
...
- **CLS Academy and allied programs** (Credit Union Act §5) train the loan-officer corps; governance and media/mentorship programs supplement, tracked via the CED.
...
New Crossroads front-loads its society: it spends generously and early on the young, because debt-free, well-trained, productive citizens are the engine of everything downstream — the self-funding healthcare system, the co-op surplus, the lean state.

- **Choice from experience, not from guessing.** Age 16 is the year to try things on — aptitude tests, a rotation through real workplaces, and up to three changes of mind. By 17, an informed commitment; by 20, four solid years of training and only a short supervised finish.

- **Citizenship, economics, and health are taught, not assumed.** The middle years build the foundation for life: how the nation governs itself, how money works for you and the economy, and how food and nutrition keep you alive. Financial literacy is personal finance, grounded in the real world of your wallet and the DLB.
