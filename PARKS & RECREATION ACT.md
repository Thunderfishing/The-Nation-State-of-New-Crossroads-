...
|-------|------------------|--------------|-----------|
| **Informal** | Cash park fees (credit union kiosks), cash payments to park vendors | Never collected | None. Constitutionally protected. |
| **Citizen** | BWC park fees under $10,000/year | No tracking | None |
| **Middle** | BWC park fees $10k–$100k/year | Aggregate totals only | Annual summary |
| **Elite** | Corporate park concessions above $100k | Full tracking | Quarterly audits |
| **Institutional** | Parks SWF allocations, CPI leases | Full transparency | Public annual reports |

**Cash park fees**: Accepted at all park entry points via credit union kiosks with no fee and no surveillance, per Monetary Act Section 1A (Informal Economy Guarantee).

### 1.2 DAI-Adjusted Loans for Parks Infrastructure

Per Monetary Act Section 1.6, all loans for park infrastructure (trails, campsites, lodges, CO2 pipelines, greenhouses) receive the **0.5% DAI floor** (service-sector treatment). CLS officers apply DAI automatically at origination.

| Loan Type | Nominal Rate | DAI-Adjusted Effective (2025, BAR=2.6%) | Floor |
|-----------|--------------|------------------------------------------|-------|
| Trail construction (co-op) | 4% | 1.4% | 0.5% |
...
## Section 2: Corridon River Basin (Funding Updated)

### 2.1 Structure (Unchanged)

- **Area**: 24,000 km² (1,200 km × 20 km), 100 km³/year flow
- **Zones**: Urban (5,000 km²), Wetlands (19,000 km²), Floodplains (10,000 km²)
- **Dredging**: 10 million m³/year ($500M/year)
- **Flood Defenses**: $5B for levees and pumps
- **Power**: 13 GW nuclear (Region 2) + 27 GW geothermal (Regions 2, 7) → 219 TWh/year

### 2.2 CO2 Pipeline and Greenhouses (Funding Updated)

| Asset | 2025 | 2075 | Funding | DAI Floor |
|-------|------|------|---------|-----------|
| CO2 pipeline (Region 3) | 750 km | 750 km | SWF + CCIF | 0.5% |
| CO2 absorption | 1.865M tons/yr | 3.115M tons/yr | — | — |
| Greenhouse pipelines (Region 5) | 2,000 km | 2,000 km | SWF + CCIF | 0.5% |
...
Where elevated freeway insect corridors (Infrastructure Act Section 2) cross the Corridon River or adjacent wetlands:
...
## Section 3: Parkweb Network (Insect Integration)

### 3.1 National Parks (100,000 km²)

- Corridon Basin (24,000 km²), Frostpeak Range (50,000 km²), Ember Range (26,000 km²)
- **Insect corridors**: Where freeways cross national parks, elevated dark corridors are mandatory. Park rangers enforce DCALS compliance for all structures within 500m of dark corridors.
...
## Section 4: Wildlife, CO2, Atmospheric Management (Unchanged Numbers, Updated Funding)

### 4.1 Corridors and Land Bridges

- 60,000 km corridors, 900 land bridges
- **Dark corridor compliance**: Land bridges under elevated freeways maintain 3–5m clearance and no lighting

### 4.2 CO2 Management

| Source | 2025 Absorption | 2075 Absorption |
|--------|-----------------|-----------------|
| Wetlands (100,000 km²) | 2M tons/yr | 3M tons/yr |
| Grasslands (50,000 km²) | 1.715M tons/yr | 1.85M tons/yr |
| Reforestation (50,000 km²) | 10.65M tons/yr | 10.65M tons/yr |
| Forests (50,000 km²) | 8.65M tons/yr | 8.65M tons/yr |
| CO2 pipeline (Region 3) | 1.865M tons/yr | 3.115M tons/yr |
| Greenhouses (Region 5) | 0.8M tons/yr | 1.0M tons/yr |
| **Total** | **25.68M tons/yr** | **28.265M tons/yr** |

**Net CO2**: -4.32M tons/yr (2025) → -21.735M tons/yr (2075)

### 4.3 Atmospheric Management (Unchanged)

- 10 reservoirs (50 km³/yr), 100,000 km² wetlands release 10 km³/yr moisture
- Cloud seeding: $2B ($100M/region)
- Feedback loop: Glacier melt (10 km³/yr, Region 7) feeds Corridon

---

## Section 5: Foreign Investment and Parks Index (Funding Updated)

### 5.1 Parks Index (CPI)

- **Revenue**: $10B/year (unchanged)
- **Ownership**: 10,000 cottages (500/region), 50-year leases, $10,000/year fee
- **Timeshares**: 5,000 units (250/region) at $5,000/year, 10% foreign ownership cap
- **Asymmetric scrutiny**: CPI transactions below $10,000 are private. Leases above $100,000 are fully tracked.
...
| Parks Index | $10B/year | $10B/year |
| CCIF to parks | $2.5B/year | $2.5B/year (third priority after Energy $5B, Urban $3B) |

**Automatic SWF stabilizers** (Monetary Act 2.3): If SWF exceeds 12% of GDP, citizen dividends are paid (50% cash, 50% BWC). Park funding is protected as a fixed allocation.

### 5.3 Alliance Network (Unchanged)

- $2.395T CCIF, 7.5% returns, $2.5B/year to parks
- 1,832 members, 65% FCL-led, 11/20 Regional Board confirmation

---

## Section 6: Co-op Clubs and Recreation (Insect Compliance Added)

### 6.1 Clubs (Unchanged)

- **30,000 clubs by 2075** (1,500/region, recreation-focused FCLs)
- **Revenue**: $20B/yr (2025) → $40B/yr (2075)
- **Profit split**: 33% healthcare ($13.2B/yr), 5% education ($2B), 22% charity ($8.8B), 40% members ($16B)

### 6.2 Dark Corridor Compliance for Club Facilities (New)
...
## Section 7: Regional Roles (Insect Corridors Added)
...
| **Region 3** | Mining, 750 km CO2 pipeline | Mining compounds must comply with DCALS |
...
| **Other regions** | Municipal parks | Retroreflective trail markers only; no powered lighting |
...
| CO2 absorption | 25.68M tons/yr | 28.265M tons/yr | — |
...
|-------|-------|---------------|-------------------------|------------------|---------|
| 1: Foundation | 2025–2035 | 200,000 | 0 (pilot 100 km in Region 5) | Pilot only | $20B SWF + $10B/yr CPI |
| 2: Expansion | 2035–2050 | 350,000 | 1,550 | 500 structures | $20B SWF + $10B/yr CPI |
| 3: Optimization | 2050–2065 | 500,000 | 2,500 | 2,500 structures | $20B SWF + $10B/yr CPI |
| 4: Completion | 2065–2075 | 540,000 | 3,000 | 5,000+ structures | $20B SWF + $10B/yr CPI |
