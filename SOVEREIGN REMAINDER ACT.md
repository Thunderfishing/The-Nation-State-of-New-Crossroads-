...
New Crossroads governs nearly the whole of its economic life through published rules, peer mutual pools, and independent audit. Money is issued by rule. Credit is priced by rule. Crises are met by pre-committed trigger. Regions insure regions; cities insure cities; co-ops fund their own capital pool.

This act establishes what remains: the short list of powers that are irreducibly discretionary, irreducibly political, and irreducibly singular. There are four — defense, prosecution, judgment, and the fund of last resort. The sovereign holds these four functions, is barred from every other, is staffed from below, recallable from below, funded without the printer, and watched by its own prosecutors and the chambers' oversight committees (Chamber Act §6.7). The sovereign is thin because the rest of the system is thick. Its size is not a policy — it is arithmetic.

---

## Section 1: The Enumeration Principle

Every state grows by discovering new problems only it can solve. The sovereign is built to make that discovery impossible: it holds an enumerated list, the list is closed, and the burden of proof is inverted — a function belongs to the sovereign only if no rule, mutual, chamber, council, or citizen vote can hold it. Doubt resolves downward, always.
...
Adding a function requires the highest amendment bar (Chamber Act §10.5): supermajorities of every chamber plus a 75% national referendum. Removing a function requires only the ordinary bar. It is easier to shrink the sovereign than to grow it.

### 1.4 Citizen Standing

Any citizen may petition the Supreme Court to review any sovereign act for consistency with this section. Standing is universal. The Court may award costs to a prevailing petitioner.

---

## Section 2: Defense and Foreign Affairs
...
### 2.1a The CMIS Anti-Surveillance Wall

- CMIS may defend national infrastructure against external attack but may never surveil the population, access the PPK beyond its own personnel records, or reach the CED.
- Cyber-defense capability is architecturally separated from any capability to monitor domestic transactions. CMIS holds only the former.
- CMIS conducts no deep espionage and no proactive foreign engagement. Any inward-facing capability is void (Section 8).
- The Intelligence and Security Committee (Chamber §6.7) verifies the wall is holding; reports published in redacted form.
...
### 2.3 Customs and the Border

- The sovereign administers the border: tariffs (~9.8% avg, ~$49B/year), the cash-export prohibition, and customs enforcement. Operations administered by Treasury (§6A.1).
- Arms-export veto: Sovereign Council finding compels suspension; chambers hold the override.
- Tariff schedules set by the chambers, administered by the sovereign. The sovereign collects; it does not decide.

### 2.4 The Global Sound-Capital Segment (statecraft powers)
...
## Section 3: The Special Auditors

The one institution that must be able to indict all others cannot be owned by any of them.

### 3.1 Composition and Appointment

- 50-75 auditors, 5-year terms. Nominated by the Sovereign Council, confirmed by the Territorial Chamber.
- **Citizen backstop:** A petition at the Chamber §6.3 threshold forces any auditor confirmation to a ratifying referendum.

### 3.2 Independence

- Removable only by joint action of the Sovereign Council and the Territorial Chamber.
- Budget constitutionally protected; set as a fixed formula share of sovereign revenue. No annual appropriation can starve an investigation.
- An official under investigation may not participate in any decision affecting that auditor.

### 3.3 Jurisdiction and Powers

- **Self-initiating:** may open an investigation into any entity — co-op, corporation, credit union, chamber, mutual fund, municipal council, sovereign organ, or officer — on their own initiative.
...
The press floor (Chamber §11, Floor 6) and the due-process floor (Floor 11) stand over this office: a free press checks a self-initiating prosecutor, and only the judiciary convicts. The Public Accounts and Financial Services Committees (Chamber §6.7) question the auditors in public session.

---

## Section 4: The Judiciary

Every power in this act is checked by a judge. The judiciary is the load-bearing organ: it makes the other three functions safe to hold.

### 4.1 Structure

**Regional courts.** 400 judges (20 per region), 10-year terms, scaling to 500 (25 per region) by 2075 as population and litigation volume grow. Appointed by the Territorial Chamber (6/11 Regional Board vote), confirmed by both Productive Chambers jointly. First-instance jurisdiction over all civil, criminal, and constitutional questions arising in their region, including the downward-presumption determinations (§1.2), pool-classification disputes (Chamber Act §6.4), floor/guarantee threshold classifications (Chamber Act §6.3), and the pre-enactment advisory rulings on Tier-1/informal obligation (Chamber Act §4.3). The system invites litigation by design — universal citizen standing (§1.4), justiciable spending classifications (§7.2), and the downward presumption (§1.2) all generate case volume that 10 judges per region cannot absorb. Twenty per region gives each judge a caseload of ~280,000 citizens — comparable to the US federal ratio, appropriate for a court that handles all first-instance jurisdiction.

**Appellate circuits.** 10 circuits of 2 regions each, 5 judges per circuit (50 total), 10-year staggered terms. Appointed by the Territorial Chamber (11/20), confirmed by both Productive Chambers jointly. Sit in panels of 3 for routine appeals; sit en banc (all 5) when a panel would overrule circuit precedent or when the question has cross-circuit implications. A circuit split — two circuits reaching opposite conclusions on the same legal question — triggers automatic Supreme Court review. Ten circuits (rather than 5) halves each circuit's geographic coverage — improving access for litigants, deepening judges' familiarity with regional conditions, and generating circuit splits faster, which brings constitutional questions to the Supreme Court sooner.

**Supreme Court.** 9 justices, 15-year staggered terms, mandatory retirement at 75, decisions by 6/9 of sitting justices (but never fewer than 5 affirmative votes regardless of vacancies). Nominated by the Territorial Chamber, confirmed by both Productive Chambers jointly. Hears constitutional questions (including floor/guarantee classification, function-assignment under the downward presumption, clarificatory-vs-substantive amendment determinations, and circuit splits), inter-regional disputes, chamber conflicts, fraud-cap appeals, takings appeals (§4.3), and floor/guarantee review (Chamber Act §11, §12). Nine justices (increased from 7) reflect the volume generated by 10 appellate circuits, universal citizen standing, and the system's invitation to litigate every constitutional boundary.

**Staggering.** Supreme Court terms are staggered so that no more than 2 vacancies arise in any 5-year period. Initial seating assigns terms of 15, 14, 13, 12, 11, 9, 7, 5, and 3 years; thereafter all terms are 15 years. Appellate judges are staggered within each circuit on a similar pattern.

**Vacancy.** A mid-term judicial vacancy is filled through the same nomination-and-confirmation path. The replacement serves the remainder of the term. A remainder of 8 years or less (Supreme Court) or 5 years or less (appellate/regional) does not bar the replacement from nomination to a subsequent full term.
...
- The only bridge between PPK identity and CED economic data. Warrant on probable cause, regional judge, two-region approval, publicly logged, citizen notified within 90 days, annual abuse audit.
- Constitutionally incapable of bulk operation. No warrant class, standing warrant, or programmatic interface.
- The single warranted door behind every privacy floor (Chamber §11 Floors 1, 2, 3, 10).

### 4.3 The Takings Power and Its Judicial Check
...
## Section 5: The Sovereign Wealth Fund

The mutuals are the system; the SWF stands behind the system when the system itself fails. Holding is not spending: the SWF's ordinary operations are automatic by rule.
...
### 5.3 What Is Discretionary

- Tier-2 emergency mode: Sovereign Council 5/7 + Territorial Chamber 15/20, hard sunsets, forced re-authorization, every action published. The one standing discretionary economic power. **Its scope is economic; it touches no entrenched floor, no protected guarantee, and no political right (§8).**
- Extraordinary SWF deployment within Tier-2, each with its own sunset.
- The Public Accounts Committee (Chamber §6.7) scrutinizes all deployments.
...
## Section 6: The Sovereign Council

The smallest body that can command the military, conduct diplomacy, nominate auditors and justices, and turn the Tier-2 key. It is not a government: no domestic programs, no agenda-setting over the chambers, no authority beyond the closed list.
...
### 6A.2 Foreign Affairs Bureau

- Staffs embassies and diplomatic communications.
- Administers treaty paperwork and the treaty-limbo process (§2.2).
- Manages global-segment listing paperwork and the Industry Act §2.5 conversion-ramp registry.
- No independent policy authority. The Council directs; the Bureau administers; the chambers ratify. Ambassadors confirmed by the Territorial Chamber.

Scrutinized by the Defense and Foreign Affairs Committee.

### 6A.3 National Lands and Commons Bureau

Custodian of the physical national commons no region or board owns:
- Parkweb infrastructure, biosphere reserves, dark-sky corridors (Parks Act).
- Inter-regional river coordination and minimum-environmental-flow obligations (Chamber §11, Floor 4).
- Sovereign metals reserve — physical custody (financial management by Treasury).
- Not a regulatory body — it holds things, not rules.

Territorial Chamber oversight; paired with Parks Act and relevant boards.

### 6A.4 Transport Bureau

- Builds and operates the 75,000 km rail network, 15,000 km freeway network, navigable channels, and national road infrastructure.
- Exercises the delegated takings power (§4.3) for national works.
- Operates green-street watershed infrastructure and nationally-scaled built commons.
- May be directed by Regional Boards to prioritize emergency logistics (Chamber §3.6).
...
## Section 7: Funding the Sovereign
...
| **Parks Index** | Auction-cleared cottage/timeshare leases (Parks Act §5.1) | ~$2B |
| **Total** | | **~$495B** |
...
- Surplus (~$71B) flows to the SWF (within the 12% cap) or to the **citizen dividend**. The sovereign cannot accumulate. Once the SWF is capped — projected ~2028 — Monetary §2.3 redirects SWF contributions to general revenue, and this section sends them onward to the dividend: **~$157B/year, ~$1,400 per citizen**, in cash, tax-free, reaching the informal majority that files nothing.
- No issuance, no debt, no SWF-principal draw.
- The Public Accounts Committee scrutinizes all spending against the cap.

---

## Section 8: The Prohibitions

Section 1 says what the sovereign holds; this section makes the complement explicit.

The sovereign may never:
...
9. **Breach any entrenched floor (Chamber §11) or protected guarantee (Chamber §12).** Both schedules are referenced as wholes. No war, emergency, or treaty pierces them. There is no suspension exception.
10. Hold any function not enumerated in Section 1.1.

A sovereign act inconsistent with this section is void, reviewable by the Supreme Court on any citizen's petition with universal standing.
...
| First-instance judgment | Regional courts (400: 20/region, scaling to 500 by 2075) | Appellate review; constitutional review |
| Appellate review | 10 circuits (2 regions each), 5 judges each (50 total) | Circuit splits trigger Supreme Court review; en banc for precedent-overrule |
| Constitutional judgment | Supreme Court (9 justices, 15-year staggered terms) | 5/7 decisions (min 4 affirmative); floor/guarantee classification; function-assignment (downward presumption) |
...
| SWF reaches its cap | ~2028 (year 3–4) | Contributions redirect to general revenue (Monetary §2.3) |
| Citizen dividend (once capped) | ~$157B/yr — ~$1,400/citizen | Cash, tax-free; the only channel reaching the informal economy |
...
| **Revenue** | **~$495B** — VAT 6% $199B · income >$100k $144B · tariffs $49B · corporate profit $25B · resources $22.7B · co-op profit $20B · property $19B · excise $15B | Cap 4% → 2% of GDP; Public Accounts Committee |
...
Almost nothing a government does requires a government. Money does not — a rule issues it. Credit does not — mutuals price it. Crises do not — triggers meet them. Equalization does not — peers insure peers. Markets do not — a rulebook and its stewards run them. What is left is short: someone must face the world, someone must indict anyone, someone must judge, and someone must keep the fund that stands behind everything else. This act is that list, and the list is closed.

- **The sovereign is arithmetic, not restraint.** Take everything the rules and mutuals govern out of a state, and this is what is left.
...
The sovereign is small because everything else is strong.

---

End of Sovereign Functions Act
