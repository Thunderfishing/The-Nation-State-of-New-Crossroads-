...
### 5.7 Foreign-Asset Sanctions-Resilience Floor (entrenched at the middle bar)

The nation's foreign and reserve assets — the SWF's foreign allocation and the foreign-currency reserve (~$275B), collectively governed by the **Treasury Investment Mandate** (Monetary Act §2.1A) — are subject to two binding constraints:
...
| Constitutional judgment | Supreme Court (7 justices, 15-year staggered terms) | 6/9 decisions (min 5 affirmative); floor/guarantee classification; function-assignment (downward presumption) |
